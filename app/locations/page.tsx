  ...
  const locations = [
    {
      ...
      description: "Renowned for having one of the highest leopard densities in the world, Yala National Park offers diverse habitats from lagoons to grasslands. It's home to elephants, sloth bears, crocodiles, and over 200 bird species.",
      highlights: ["Sri Lankan leopards", "Asian elephants", "Sloth bears", "Saltwater crocodiles", "Diverse bird species"],
      bestTime: "February to July",
      image: "/assets/parks/R (1).jpeg",
      mapLink: "https://www.google.com/maps/place/Yala+National+Park/@6.4639613,81.4693098,17z/data=!3m1!4b1!4m6!3m5!1s0x3ae5d3a62ffb9359:0x3bb623d70b5a3314!8m2!3d6.4639613!4d81.4718847!16zL20vMDJxMXo1?entry=ttu&g_ep=EgoyMDI1MDgxMi4wIKXMDSoASAFQAw%3D%3D"
    },
    {
      name: "Udawalawe National Park",
      description: "Famous for its elephant population, Udawalawe National Park provides one of the best wildlife viewing experiences in Sri Lanka. The park centers around the Udawalawe Reservoir, creating ideal conditions for elephants, water birds, and other wildlife.",
      highlights: ["Large elephant herds", "Water buffalo", "Spotted deer", "Peacocks", "Eagles and hawks"],
      bestTime: "All year round, with peak from May to September",
      image: "/assets/parks/udawlwa.jpeg",
      mapLink: "https://www.google.com/maps/search/Udawalawe+National+Park/@6.456513,80.8620081,14z/data=!3m1!4b1?entry=ttu&g_ep=EgoyMDI1MDgxMi4wIKXMDSoASAFQAw%3D%3D"
    },
    {
      name: "Sigiriya and Surroundings",
      description: "While famous for its ancient rock fortress, the areas surrounding Sigiriya offer unique wildlife opportunities. The mix of forests, water bodies, and grasslands creates diverse habitats for many species.",
      highlights: ["Gray langurs", "Toque macaques", "Land monitors", "Diverse butterfly species", "Rich birdlife"],
      bestTime: "January to April",
      image: "/assets/parks/sigiriy.jpg",
      mapLink: "https://www.google.com/maps/place/Sigiriya/@7.9570327,80.7576821,17z/data=!3m1!4b1!4m6!3m5!1s0x3afca15b724c9ab3:0xab1771275b370d52!8m2!3d7.9570327!4d80.760257!16zL20vMDRnX2tr?entry=ttu&g_ep=EgoyMDI1MDgxMi4wIKXMDSoASAFQAw%3D%3D"
    }
  ];
    ...
    <div className="pt-24 pb-16">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-playfair font-bold mb-6">Photography Locations</h1>
          ...
          {locations.map((location, index) => (
            <section key={index} className={`grid grid-cols-1 lg:grid-cols-2 gap-12 items-center ${index % 2 === 1 ? 'lg:flex-row-reverse' : ''}`}>
              <div className="space-y-6">
                <h2 className="text-3xl md:text-4xl font-playfair font-bold">{location.name}</h2>
                
                <p>{location.description}</p>
                
                <div>
                  <h3 className="text-lg font-semibold mb-3 flex items-center gap-2">
                    <Camera className="h-5 w-5 text-primary" /> Wildlife Highlights
                  </h3>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span><strong>Best Time to Visit:</strong> {location.bestTime}</span>
                </div>
                ...
                <div className="flex flex-wrap gap-4 pt-2">
                  ...
                  <Button asChild variant="outline" className="rounded-full">
                    <a href={location.mapLink} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
        ...
        <section className="mt-16 md:mt-24 mb-16 bg-card rounded-xl p-8 md:p-12">
          <h2 className="text-3xl font-playfair font-bold mb-6 text-center">Photography Tips for Sri Lankan Wildlife</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="bg-background p-6 rounded-lg border">
                <h3 className="text-lg font-playfair font-semibold mb-3">{tip.title}</h3>
        ...
        <section className="text-center bg-primary text-primary-foreground rounded-xl p-8 md:p-12">
          <div className="max-w-2xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-playfair font-bold mb-6">Join a Photography Expedition</h2>
            <p className="mb-8">
